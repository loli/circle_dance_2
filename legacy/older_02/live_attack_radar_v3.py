                ...
                if isinstance(decoded, dict):
                    ...
                    for i in range(12):
                        ...
                        if attack > self.attack_threshold and new_e[i] >= (
                            ...
                            # Use a fixed maximum (1.0) rather than a dynamic one.
                            # This ensures quiet sounds stay visually small.
                            norm_attack = (attack - self.attack_threshold) / 0.8  # 0.8 is a good 'loud' ceiling
                            norm_attack = max(0, min(1.0, norm_attack))  # Clamp between 0 and 1
